...
def main (args):
    ...
    if args.track == 'Track1':
        cv_ap_scores_valid = Pickleload("./Track_Inputs/" + args.outcome_name + "_" + args.site + "_" + args.track + "_" + "cv_ap_scores_valid")
        cv_inter_cols = Pickleload("./Track_Inputs/" + args.outcome_name + "_" + args.site + "_" + args.track + "_" + "cv_inter_cols")
        cv_inter_structure = Pickleload("./Track_Inputs/" + args.outcome_name + "_" + args.site + "_" + args.track + "_" + "cv_inter_structure")
        chi2_ap_scores_valid = Pickleload("./Track_Inputs/" + args.outcome_name + "_" + args.site + "_" + args.track + "_" + "chi2_ap_scores_valid")
        chi2_inter_cols = Pickleload("./Track_Inputs/" + args.outcome_name + "_" + args.site + "_" + args.track + "_" + "chi2_inter_cols")
        chi2_inter_structure = Pickleload("./Track_Inputs/" + args.outcome_name + "_" + args.site + "_" + args.track + "_" + "chi2_inter_structure")
        ig_ap_scores_valid = Pickleload("./Track_Inputs/" + args.outcome_name + "_" + args.site + "_" + args.track + "_" + "ig_ap_scores_valid")
        ig_inter_cols = Pickleload("./Track_Inputs/" + args.outcome_name + "_" + args.site + "_" + args.track + "_" + "ig_inter_cols")
        ig_inter_structure = Pickleload("./Track_Inputs/" + args.outcome_name + "_" + args.site + "_" + args.track + "_" + "ig_inter_structure")
        cv_ns_list = Pickleload("./Track_Inputs/" + args.outcome_name + "_" + args.site + "_" + args.track + "_" + "cv_ns_list")
        chi2_ns_list = Pickleload("./Track_Inputs/" + args.outcome_name + "_" + args.site + "_" + args.track + "_" + "chi2_ns_list")
        ig_ns_list = Pickleload("./Track_Inputs/" + args.outcome_name + "_" + args.site + "_" + args.track + "_" + "ig_ns_list")
