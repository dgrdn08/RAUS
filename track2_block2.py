...
def main (args):
    ...
    chisquarerank, variable_order, target = ChiSquareRank(df_Train,args.COLS,args.TARGET)
    ...
    save_figure1,save_figure2 = RAUSPlot(chisquarerank,'Chi_Square',args.clipback,args.clipfront,variable_order,args.site,args.outcome_name,args.adjusted,'Chi-Squared',args.track)
    ...
    if args.select_percentile == 1:
        selectpct, variable_order = SelectPercentile(chisquarerank,'Chi_Square',variable_order,args.percentile)
    ...
    if args.outcome_name == 'TVT':
        ...
        chi2_roc_aucs_valid, chi2_ap_scores_valid, chi2_fprs_valid, chi2_tprs_valid, chi2_thresholds_valid = bn_performance_metrics_tt(df,df2,chi2_dataTrainValid,target,args.sequence_length_bn,'chisquarerank',args.outcome_name,args.site,args.adjusted,args.ncases,args.track)
