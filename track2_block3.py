...
def main (args):
    ...
    ig_mi_ranking, variable_order, target = IG_MI_Ranking(df_Train,args.TARGET,args.COLS)
    ...
    save_figure1,save_figure2 = RAUSPlot(ig_mi_ranking,'Information_Gain',args.clipback,args.clipfront,variable_order,args.site,args.outcome_name,args.adjusted,'Information Gain',args.track)
    ...
    if args.select_percentile == 1:
        selectpct, variable_order = SelectPercentile(ig_mi_ranking,'Information_Gain',variable_order,args.percentile)
