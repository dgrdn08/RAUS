...
##############################################################################################
    ...
    cramersvrank, cv_variable_order, target = CramersVRank(df_Train,args.COLS,args.TARGET)
    ...
    save_figure1,save_figure2 = RAUSPlot(cramersvrank,'Effect_Size',args.clipback,args.clipfront,cv_variable_order,args.site,args.outcome_name,args.adjusted,'Cramers V/ Effect Size',args.track)
    if args.rank_filter == 1:
        cv_variable_order = [x for x in cv_variable_order if x not in args.cv_rank_filter2]
    if args.select_best_k == 1:
        cv_variable_order = cv_variable_order[:args.cv_top_features]
    if args.select_percentile == 1:
        selectpct, cv_variable_order = SelectPercentile(cramersvrank,'Effect_Size',cv_variable_order,args.percentile)
    df = temporal_undersampling(df_Train,args.TARGET,args.outcome_name,'cramersv',args.site,args.adjusted,args.track)
    ...
    #print(cv_ns_list)
    cv_dag = intra_struct(df,cv_intra_cols,cv_ns_list,'cramersv',args.outcome_name,args.site,args.adjusted,args.track,args.max_fan_in)
    ...
    if args.outcome_name == 'egfr_reduction40_ge':
        ...
        cv_inter_structure = inter_struct(df,cv_inter_cols,cv_ns_list,'cramersv',args.outcome_name,args.site,args.adjusted,args.sequence_length_dbn,args.track,args.max_fan_in)

    #graph visualization
    figure1,figure2 = draw_inter_structure(cv_inter_structure,cv_intra_cols,'cramersv',args.outcome_name,args.site,args.adjusted,args.track,args.clipback,args.clipfront)
    #graph visualization
    ...
    if args.outcome_name == 'egfr_reduction40_ge':
        ...
        cv_dataTrainValid = DBNModel_TT(df,df2,cv_inter_cols,cv_inter_structure,args.sequence_length_dbn,args.max_iter,cv_dag,cv_ns_list,'cramersv',args.outcome_name,args.site,args.adjusted,args.track,args.ncases)
