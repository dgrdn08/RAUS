...
function dataTrainValid = BNModelLearn_TVT(dag, intraLength, numNodes, max_iter, dataTrain, dataValid, dataTest,ns,horizon,ncases)
      ...
      disp('Learning BN Parameters, Which May Take Some Time...');
          %%%%%%%%%%%%%%%%%%%% learn bn %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
          [bnet2, LLtrace] = learn_params_em(engine,casesTrain);
          %[bnet2, LLtrace] = learn_params_em(engine, casesTrain);
          %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
